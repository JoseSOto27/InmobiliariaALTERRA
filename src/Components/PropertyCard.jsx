    ...
    >
      ...
      <div className="relative overflow-hidden aspect-[4/3] bg-neutral-50">
        ...
        {(property.tag || property.esquema) && (
          <span className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm text-[#333333] font-medium text-[11px] px-3 py-1 rounded-full shadow-sm border border-neutral-200/40">
            {property.tag || property.esquema}
          </span>
        )}
      </div>
      ...
      <div className="p-5 flex flex-col flex-grow text-left">
        ...
        {/* 🎠 CARRUSEL DE AMENIDADES CON ICONOS INDIVIDUALES */}
